					...
					@foreach($toppost as $post)
						<div class="blog-grids wow fadeInDown"  data-wow-duration=".8s" data-wow-delay=".2s">
							<div class="blog-grid-left">
								<a href="{{url('singleview/'.$post->id)}}"><img src="{{asset('post/'.$post->ImageFile)}}" width="30" height="30px" class="img-responsive" alt=""></a>
							</div>
							<div class="blog-grid-right">
								
								<h5><a href="{{url('singleview/'.$post->id)}}">{{$post->title}}</a> </h5>
							</div>
